...
| :--- | :--- | :--- |
| EDA & KPI Analysis | Feature Engineering | Python (Django/DRF) |
| Logistics & Revenue Insights | Model Evaluation | API-First Systems |
| Executive Storytelling | Applied ML | Backend Architecture |
...
### 📦 [Logistics Performance Analysis](https://github.com/Fareed04/logistics-performance-analysis)
Identified a "Double Loss" where late deliveries increased freight costs by **12%** and dropped satisfaction to **2.56/5**. Focused on São Paulo and Rio de Janeiro hubs.

### 🛒 [Superstore Sales Analysis](https://github.com/Fareed04/sales-performance-analysis)
Analyzed **$2.2M+** in revenue to pinpoint **Technology and Phones** as the core drivers of business growth.

### 🏥 [Healthcare Translation System](https://github.com/Fareed04/healthcare_translation_project)
Built a real-time speech-to-text system combining **Applied ML** with a **Python/Django** backend.
